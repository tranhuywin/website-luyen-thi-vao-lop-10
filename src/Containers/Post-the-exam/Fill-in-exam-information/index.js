            ...
            <form className='mx-auto'>
                <div className="form-group">
                    <div className="form-inline">
                        ...
                        <select className="custom-select my-1 mr-sm-2" defaultValue='thi thật' onClick={handleValueTitleTheExam}
                            id="selectExamFormat">
                        ...
                        <select className="custom-select my-1 mr-sm-2" defaultValue='90p' onClick={handleValueTitleTheExam}
                            id="selectExamTime">
                            <option value="15p">15p</option>
                            <option value="30p">30p</option>
                            <option selected value="45p">45p</option>
                ...
                <div className="form-group">
                    <div className="form-inline">
                        ...
                        <select className="form-control" defaultValue='Toán' onClick={handleValueTitleTheExam} 
                        id="selectSubjects">
                            <option>Toán</option>
                        ...
                        <select className="custom-select my-1 mr-sm-2" defaultValue='1' onClick={handleValueTitleTheExam}
                         id="selectTimesExam">
                        ...
                        <select className="custom-select my-1 mr-sm-2" defaultValue='2019-2020' onClick={handleValueTitleTheExam}
                         id="selectSchoolYear">
